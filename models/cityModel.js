...
const citySchema = new mongoose.Schema(
  {
    cityName: {
      ...
      trim: true,
      maxLength: [32, 'A location name can have max 32 characters'],
      minLength: [3, 'A location name can have min 3 characters'],
    },
    country: {
      type: String,
      required: [true, 'Country is required'],
      trim: true,
      maxLength: [32, 'A country name can have max 32 characters'],
      minLength: [3, 'A country name can have min 3 characters'],
    },
    emoji: {
      type: String,
