  ...
  <html style="margin: 0; padding: 0;">
    ...
    <body style="margin: 0; padding: 0;">
      <table class="table" cellpadding="0" cellspacing="0" style="background-color: #eee; empty-cells: hide; margin: 0 auto; padding: 0; width: 600px;">
        ...
        <tr>
            <td style="background-color: #999592; margin: 0 auto;padding: 15px 25px;">
                <p style="box-sizing: border-box; color: white; font-family: Helvetica, Arial, sans-serif; letter-spacing: 0.5px; line-height: 1.4; margin: 0;  text-align: center; font-size:13px">
                  ${message}            
                </p>      
                <a style="margin: 12px 0; text-align: center;" href=${url}>${url}</a>           
              </td>
        </tr>
      </table>
    </body>
